    ...
    return (
        <>
            <div className="flex flex-col justify-between bg-[#E79700] pb-96 w-full p-20">
                ...
                <div className="flex flex-row mt-28 text-[#001F66] justify-between">
                    <div className="flex flex-col gap-2">
                        <p className='text-6xl'>12+</p>
                        <div className="h-1 w-full bg-[#001F66]"></div>
                        <p className='w-2/3 leading-none'>Years of experience in real estate</p>
                    </div>
                    <div className="flex flex-col gap-2">
                        <p className='text-6xl'>800+</p>
                        <div className="h-1 w-full bg-[#001F66]"></div>
                        <p className='w-3/4 leading-none'>Real estate projects</p>
                    </div>
                    <div className="flex flex-col gap-2">
                        <p className='text-6xl'>5+</p>
                        <div className="h-1 w-full bg-[#001F66]"></div>
                        <p className='w-3/4 leading-none'>Million sq. ft sold.</p>
                    </div>
                </div>
