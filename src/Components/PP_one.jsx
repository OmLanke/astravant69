                        ...
                        <div className="flex flex-row gap-2 justify-between items-center ">
                            <div className="flex flex-col w-1/2">
                                <div className="flex flex-row gap-1 items-center justify-start lg:text-xl">
                                    ...
                                    <p className='lg:pl-2'>{property.ready ? property.ready : "Ready to Move"}</p>
                                </div>
                            ...
                            <div className="flex flex-col w-1/2">
                                <div className="flex flex-row gap-1 pb-3 items-center justify-start lg:text-xl">
                                    ...
                                    <p className='lg:pl-2'>{property.verified ? property.verified : "Officially Verified"}</p>
                                </div>
                                <div className="w-3/4 h-1 bg-black"></div>
                            </div>
                        </div>
                        <div className="flex flex-row justify-between gap-2 items-center ">
                            <div className="flex flex-col w-1/2">
                                <div className="flex flex-row gap-1 lg:gap-3 pt-2 pb-2 items-center justify-start lg:text-xl">
                                    ...
                                    <p className='lg:pl-2'>{property.bhk ? property.bhk : "Officially Verified"}</p>
                                </div>
                                <div className="w-3/4 h-1 bg-black"></div>
                            </div>
                            <div className="flex flex-col w-1/2">
                                <div className="flex flex-row gap-1 items-center justify-start lg:text-xl">
                                    ...
                                    <p className='lg:pl-2'>{property.parking ? property.parking : "Parking Available"}</p>
                                </div>
                                <div className="w-3/4 h-1 bg-black"></div>
                            </div>
                        </div>
