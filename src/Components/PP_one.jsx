        ...
        <>
            <div className="w-full flex flex-col mx-auto gap-10 bg-white p-8 ">
                ...
                <div className="flex flex-row justify-between gap-14 items-center">
                    ...
                    <p className='w-1/6 text-3xl'>$ 105K CR</p>

                </div>
                <div className="flex flex-row gap-10">
                    <img src="proper.svg" className='w-1/2' alt="" />
                        ...
                        <div className="flex flex-row justify-between items-center ">
                            ...
                            <div className="flex flex-col w-1/2">
                                <div className="flex flex-row gap-3 pb-2 pt-1 items-center justify-start lg:text-xl">
                                    ...
                                    <p>4/2 wheeler parking</p>
                                </div>
                                <div className="w-3/4 h-1 bg-black"></div>
                            </div>
                        </div>
                        <div className="w-5/6">
                            <p>This stunning residence offers 4 bedrooms, a den, 2 loft bonus spaces, and 5 bathrooms, blending modern functionality with sophisticated design. The great room is ideal for effortless entertaining, seamlessly transitioning into a dining space featuring a bar area and wine storage. Culinary enthusiasts will appreciate the gourmet kitchen, equipped with high-end appliances and a spacious island. The owner's suite is a sanctuary with a seating area, an en-suite spa-like bath, and a custom closet. The second floor includes 3 bedrooms, 2 loft spaces, and a secondary laundry area, emphasizing thoughtful design. Car enthusiasts will revel in the 3-car garage with epoxy flooring and a car lift for additional storage. </p>
                        </div>
                    </div>
                </div>
                <div className="flex flex-row gap-2 w-full">
                    <img className='w-[320px]' src="image 2.png" alt="" />
                    <img className='w-[320px]' src="image 3.png" alt="" />
                    <img className='w-[320px]' src="image 4.png" alt="" />
                    <img className='w-[320px]' src="image 5.png" alt="" />
